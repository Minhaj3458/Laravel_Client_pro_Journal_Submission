          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
             ...
             <!-- /.card-header -->
              ...
              <form id="quickForm" action="{{ url('admin/store_information') }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="name">User Name</label>
                    <select class="select2 form-control" name="user_id" multiple="" data-placeholder="Select a username" style="width: 100%;" required>
                    @if ($users)
                      @foreach ($users as $show )
                          <option value="{{$show->id}}">{{$show->user_name}}</option>
                      @endforeach 
                    @endif
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" name="number" maxlength="14" class="form-control" id="phone" placeholder="Phone Number" >    
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary h3">Create Information</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
