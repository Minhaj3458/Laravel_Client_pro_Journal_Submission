...
<head>
  ...
  <title>Auth Registration Page</title>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      @if(session()->has('message'))
       ...
       @endif
      <p class="login-box-msg">Register a new author membership</p>

      <form  action="{{ url('auth/registration_store') }}"  method="POST">
         @csrf
      ...
      <a href="{{ url('auth/login_page')}}" class="text-center">Login</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
