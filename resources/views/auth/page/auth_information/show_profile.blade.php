          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
               @if ($user_profile->auth_info)
                       <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle"
                        src="{{asset('assets/auth_profile/'.$user_profile->auth_info->image)}}"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  @if ($user_profile->auth_info)
                   <li class="list-group-item">
                    <b>Full name</b> 
                     <p class="float-right">{{ $user_profile->auth_info->name}}</p>
                   </li>
                   <li class="list-group-item">
                    <b>Phone Number</b> <p class="float-right">{{ $user_profile->auth_info->number}}</p>
                  </li>
                   @else
                     <li class="list-group-item">
                     <b>Full name</b> 
                ...
                <a href="{{ url('auth/create_profile') }}" class="btn btn-primary btn-block"><b>Create Profile</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary card-outline">
             ...
             @if ($user_profile->auth_info)
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                    {{ $user_profile->auth_info->address }}
                </p>
