        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('reviewer/manage_journal') }}">manage Journal</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
             ...
             <!-- /.card-header -->
              ...
              <form id="quickForm" action="{{ url('reviewer/store_journal') }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="row">
                 <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    id="student_id" placeholder="Enter Student Id"  required>
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    id="batch" placeholder="Enter Batch"  required>
                  </div>
                 <div class="form-group">
                    <label for="phone">Email</label>
                    <input type="email" name="email" maxlength="80" class="form-control" id="phone" placeholder="Enter Email" required  required>    
                  </div>
                  <div class="form-group">
