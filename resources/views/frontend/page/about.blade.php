...
@endsection
@section('slider')
<div id="banner-area" class="banner-area" style="background-image:url({{ asset('assets/frontends/images/slider-main/slider4.jpg') }})">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mt-5 mt-lg-0">
          ...
          <div id="page-slider" class="page-slider small-bg">
              ...
              <div class="item" style="background-image:url({{ asset('assets/frontends/images/slider-main/slider3.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Journal</h2>
                      </div>    
                    </div>
                </div>
              </div><!-- Item 1 end -->

              <div class="item" style="background-image:url({{ asset('assets/frontends/images/slider-main/slider5.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Journal</h2>
              ...
              <div class="item" style="background-image:url({{ asset('assets/frontends/images/slider-main/slider4.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Journal</h2>
