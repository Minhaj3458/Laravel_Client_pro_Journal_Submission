...
class journalController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('auth.page.journal.manage_journal',compact('journal'));
    }
    ...
    public function create()
    {
      ...
      return view('auth.page.journal.create_journal',compact('journal_type'));
    }
    ...
    {
        $pdf = Journal::find($id);
        return view('auth.page.journal.show_pdf',compact('pdf'));
    }
